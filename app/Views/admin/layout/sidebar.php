...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="Home" class="brand-link">
        ...
        <span class="brand-text font-weight-light">MI IMAM SYAFI'I</span>
    </a>
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= base_url('siswa/add_siswa'); ?>" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Siswa</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('nilai/add_nilai'); ?>" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Nilai</p>
                            </a>
                        </li>
